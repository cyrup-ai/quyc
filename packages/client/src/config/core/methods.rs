//! Configuration builder methods and convenience functions
//!
//! Provides builder-pattern methods for HttpConfig to enable fluent
//! configuration with comprehensive documentation and examples.
