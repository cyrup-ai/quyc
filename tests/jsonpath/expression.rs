...
//!
//! Tests for JSONPath expression functionality, mirroring src/json_path/expression.rs
//!
//! This module contains comprehensive tests for:
//! - Expression evaluation engine validation
//! - Official RFC 9535 examples verification
//! - Edge case handling in expression processing
