//! RFC 9535 Comparison Operator Edge Case Tests
//!
//! Tests edge cases for comparison operators including empty nodelists,
//! type mismatches, numeric precision, Unicode string comparison, and structured values
